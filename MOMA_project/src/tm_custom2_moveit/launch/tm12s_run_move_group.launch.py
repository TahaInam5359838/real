############################################################################################### 
#  tm12s_run_move_group.launch.py
#   
...
def generate_launch_description():
    ...
    description_path = 'amr_visualisation'
    xacro_path = 'robot.urdf.xacro'
    moveit_config_path = 'tm_custom2_moveit'    
    srdf_path = 'config/robot.srdf'
    ...
    pilz_planning_yaml = load_yaml(moveit_config_path, 'config/pilz_industrial_motion_planner_planning.yaml')
    ...
    cartesian_limits_yaml = load_yaml(
            moveit_config_path, 'config/pilz_cartesian_limits.yaml'
        )
