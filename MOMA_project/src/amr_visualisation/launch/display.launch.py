...
def generate_launch_description():
	...
	# ros2 run rviz2 rviz2 --ros-args -p rviz_config_file:="src/amr_visualisation/config/amr_rviz.rviz"
    # RViz
	...
	# ros2 run robot_state_publisher robot_state_publisher --ros-args -p robot_description:="src/amr_visualisation/config/amr_rviz.rviz"
    # Publish Robot
